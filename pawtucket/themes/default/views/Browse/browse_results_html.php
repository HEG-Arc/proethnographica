...
?>
		<H1>
<?php
			print _t('%1 %2 %3', $vn_result_size, ($va_browse_info["labelSingular"]) ? $va_browse_info["labelPlural"] : $t_instance->getProperty('NAME_PLURAL'), ($vn_result_size == 1) ? _t("trouvé(e)") : _t("trouvé(e)s"));	
?>		
			<div class="btn-group">
